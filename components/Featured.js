...
const styles = {
	...
	title: "text-xl font-bolder mb-[20px] mt-[30px] mb-24 ml-[30px]",
	cards: "h-full w-full flex gap-[100px] justify-between mb-[30px] ml-[30px]",
	card: `h-[130px] w-[400px] p-[20px] rounded-3xl bg-gradient-to-l from-[#0d141c] to-[#42667e] relative cursor-pointer transition-all duration-300  hover:scale-105 hover:shadow-xl border-2 border-[#fb9701]`,
